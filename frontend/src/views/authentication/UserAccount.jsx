...
// SECURITY FIX: Remove role from validation since it's no longer editable
...
const UserAccount = () => {
  ...
  const initialUserValues = {
    ...
    confirm_password: '',
    role: userInfo.role || 'student', // Role is now display-only
  };
  ...
  // SECURITY FIX: Remove role from submission data
    ...
    if (password !== confirm_password) {
      ...
      try {
        const res = await updateProfile({
          ...
          email,
          password,
          // Role is intentionally omitted - backend will preserve original role
        }).unwrap();
